...
public class CoursController {
	...
	public String listeCours(Model model,Principal principal) {
		...
		return "cours/listeCoursW";
	}
	// Liste des competences d'un cours
		@RequestMapping("/liste/competences/{coursCode}")
		public String listeCompetencesCours(@PathVariable String coursCode,Model model,Principal principal) {
			model.addAttribute("coursCompetenceList",competenceDAO.getCompetencesOfCours(coursCode));
			model.addAttribute("coursCode",coursCode);
			return "cours/listeCompetencesW";
		}
		// Liste des modules d'un cours
		@RequestMapping("/liste/modules/{coursCode}")
		public String listeModulesCours(@PathVariable String coursCode,Model model,Principal principal) {
			model.addAttribute("coursModuleList",moduleDAO.getModulesCours(coursCode));
			model.addAttribute("coursCode",coursCode);
			return "cours/listeModulesW";
		}
